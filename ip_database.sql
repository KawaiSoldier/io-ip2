...
-- Üretim Zamanı: 20 Mar 2024, 19:50:56
...
(10, 'ROBOBAX', ' Mithatpaşa Cad. No:56 Depark, 35330 Balçova/İzmir', '2024-03-20 12:19:35'),
(11, 'Çorum Özgür Leblebi', 'Çorum Sungurlu ', '2024-03-20 12:20:18');
...
CREATE TABLE IF NOT EXISTS `brands_log` (
  ...
  `old_id` int NOT NULL,
  `old_img_url` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
